...
#define SW_HASHER_ERROR               0xE00F
#define SW_BUFFER_ERROR               0xE010
#define SW_U64_OVERFLOW               0xE011
#define SW_BIP32_BAD_PATH             0xE012
#define SW_INTERNAL_CRYPTO_ERROR      0xE013
#define SW_NOT_ENOUGH_DATA            0xE014
#define SW_TOO_MUCH_DATA              0xE015
#define SW_ADDRESS_GENERATION_FAILED  0xE016
#define SW_SCHNORR_SIGNING_FAILED     0xE017
#define SW_BAD_FRAME_SIGNATURE        0xE018
#define SW_BAD_NET_TYPE_VALUE         0xE019
#define SW_SMALL_CHUNK                0xE01A
